...
//altfp_mult CBX_AUTO_BLACKBOX="ALL" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Stratix III" EXCEPTION_HANDLING="NO" PIPELINE=11 REDUCED_FUNCTIONALITY="NO" ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 clk_en clock dataa datab result
...
module  altfp_mult_ex_altfp_mult_fho
	( 
	clk_en,
	clock,
	dataa,
...
endmodule //altfp_mult_ex_altfp_mult_fho
//VALID FILE
...
module altfp_mult_ex (
	...
	altfp_mult_ex_altfp_mult_fho	altfp_mult_ex_altfp_mult_fho_component (
				.clk_en (clk_en),
				.clock (clock),
				.datab (datab),
				.dataa (dataa),
