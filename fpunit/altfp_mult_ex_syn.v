...
//altfp_mult DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Stratix III" EXCEPTION_HANDLING="NO" PIPELINE=11 REDUCED_FUNCTIONALITY="NO" ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 clk_en clock dataa datab result
...
//lpm_mult DEDICATED_MULTIPLIER_CIRCUITRY="YES" DEVICE_FAMILY="Stratix III" LPM_PIPELINE=5 LPM_REPRESENTATION="UNSIGNED" LPM_WIDTHA=24 LPM_WIDTHB=24 LPM_WIDTHP=48 LPM_WIDTHS=1 aclr clken clock dataa datab result
...
`endif
	...
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) dffe6a <= 48'b0;
		else if  (clken == 1'b1)   dffe6a <= wire_mac_out5_dataout[71:24];
	// synopsys translate_off
	initial
		dffe7a = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) dffe7a <= 48'b0;
		else if  (clken == 1'b1)   dffe7a <= dffe6a;
	...
	assign
		result = dffe7a;
endmodule //altfp_mult_ex_mult

//synthesis_resources = dsp_18bit 4 lut 55 reg 389 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_mult_ex_altfp_mult
	( 
	clk_en,
	clock,
	dataa,
...
`endif
	...
	altfp_mult_ex_mult   man_product2_mult
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
...
endmodule //altfp_mult_ex_altfp_mult
//VALID FILE
...
module altfp_mult_ex (
	...
	altfp_mult_ex_altfp_mult	altfp_mult_ex_altfp_mult_component (
				.clk_en (clk_en),
				.clock (clock),
				.datab (datab),
				.dataa (dataa),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_mult_ex.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_mult_ex.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_mult_ex.bsf TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_mult_ex_inst.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_mult_ex_bb.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_mult_ex.inc FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_mult_ex.cmp FALSE TRUE
