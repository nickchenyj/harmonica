...
>>>>>>> 4411a87dea8bf13fd4c5e8b1eab067a60baffc4b
 ...
 * 
 */
template <unsigned N, unsigned R, unsigned SIZE> class SramLsu : public FuncUnit<N, R>{
private:
	chdl::node isReady;
public:
	virtual chdl::node ready() { return isReady; }
